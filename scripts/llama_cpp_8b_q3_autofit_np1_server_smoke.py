...
Executes the preregistered one-variable rescue by reusing the frozen Q3 auto-fit
server-smoke implementation and adding only explicit single-sequence server
parallelism plus validation that the server actually initialized one slot.
"""
...
REPLACEMENTS = {
    ...
    'MODEL_ALIAS = "loom-qwen3-8b-q3-autofit"':
        'MODEL_ALIAS = "loom-qwen3-8b-q3-autofit-np1"',
    'PORT = 18083': 'PORT = 18084',
    'needles = ("fit", "offload", "gpu layer", "gpu_layers", "n_gpu_layers", "metal")':
        'needles = ("fit", "offload", "gpu layer", "gpu_layers", "n_gpu_layers", "metal", "n_slots", "n_ctx_slot")',
    'print("LOOM llama.cpp 8B Q3 Auto-Fit Server Smoke 001")':
        'print("LOOM llama.cpp 8B Q3 Auto-Fit NP1 Server Smoke 001")',
    '"experiment": "llama.cpp 8B Q3 Auto-Fit Server Smoke 001"':
        '"experiment": "llama.cpp 8B Q3 Auto-Fit NP1 Server Smoke 001"',
    '"gpu_layers_override": None,\n            "fit": "on",':
        '"gpu_layers_override": None,\n            "n_parallel": 1,\n            "fit": "on",',
    'out_dir = llama_root / "8b-q3-autofit-server-smoke" / run_id':
        'out_dir = llama_root / "8b-q3-autofit-np1-server-smoke" / run_id',
    '        "-c", str(CTX),\n        "-fa", "auto",':
        '        "-c", str(CTX),\n        "-np", "1",\n        "-fa", "auto",',
    'print("Launching llama-server with automatic fit...", flush=True)':
        'print("Launching llama-server with automatic fit and -np 1...", flush=True)',
...
def main() -> int:
    ...
    namespace = {
        "__name__": "loom_llama_cpp_8b_q3_autofit_np1_impl",
        "__file__": str(here),
        "__package__": None,
    }
