#!/usr/bin/env python3
"""LOOM llama.cpp 8B Q2 Capability 002.

Repeats the frozen Q2_K condition after Capability 001 was invalidated because
llama-cli remained in interactive conversation mode. This runner reuses the
exact frozen Q4 implementation and adds only the documented single-turn flag to
Stage A, while preserving all model/runtime/context/guardrail settings.
"""
...
REPLACEMENTS = {
    '"""LOOM llama.cpp 8B Q4 Capability 001.': '"""LOOM llama.cpp 8B Q2 Capability 002.',
    ...
    '"experiment": "llama.cpp 8B Q4 Capability 001"':
        '"experiment": "llama.cpp 8B Q2 Capability 002"',
    'print("LOOM llama.cpp 8B Q4 Capability 001")':
        'print("LOOM llama.cpp 8B Q2 Capability 002")',
    'out_dir = llama_root / "8b-q4" / run_id':
        'out_dir = llama_root / "8b-q2-002" / run_id',
...
def main() -> int:
    ...
    namespace = {
        "__name__": "loom_llama_cpp_8b_q2_002_impl",
        "__file__": str(here),
        "__package__": None,
    }
