#!/usr/bin/env python3
"""LOOM Stretch 031 — balanced M2 vs M5 geometry comparison, harness Fix2.

Fix2 never reuses failed constituents. It validates rendered sources plus the
...
from stretch_single_pass_geometry_harness_031_fix2 import default_preflight_dir, preflight

SOURCE_M5_PATH = Path("scripts/stretch_single_pass_m5_ten_token_control_031_fix2.py")
SOURCE_M5_BLOB = "1966c053b29ce178db38d175f97dcad25db75d51"
SOURCE_M2_PATH = Path("scripts/stretch_single_pass_m2_ten_token_variant_031_fix2.py")
SOURCE_M2_BLOB = "c8c74b0c6d370abb430da351876dee5ac4a4c3ac"
...
def main() -> int:
    ...
    if args:
        ...
        try:
            ...
            print(f"Classification: STRETCH_031_FIX2_PREFLIGHT_FAIL", file=sys.stderr)
    ...
    try:
        ...
        print("Classification: STRETCH_031_FIX2_PREFLIGHT_FAIL", file=sys.stderr)
        print(f"Failure reason: {type(exc).__name__}: {exc}", file=sys.stderr)
        return 2
    ...
    run_dir = repo / "results-local" / "stretch" / "single-pass-m2-m5-geometry-comparison-031-fix2" / run_id
    run_dir.mkdir(parents=True, exist_ok=False)
    summary_path = run_dir / "summary.json"
    summary: dict = {
        "experiment": "Stretch 031 — Balanced M2 vs M5 SINGLE_PASS Geometry Comparison Fix2", 
        "harness_revision": "Fix2: explicit shim parent/child dispatch + no-model transport preflight", 
