#!/usr/bin/env python3
"""LOOM llama.cpp 8B Q2 Capability 001.

Runs the preregistered Q2_K condition by reusing the frozen, already-exercised
...
REPLACEMENTS = {
    '"""LOOM llama.cpp 8B Q4 Capability 001.': '"""LOOM llama.cpp 8B Q2 Capability 001.',
    ...
    '"experiment": "llama.cpp 8B Q4 Capability 001"':
        '"experiment": "llama.cpp 8B Q2 Capability 001"',
    'print("LOOM llama.cpp 8B Q4 Capability 001")':
        'print("LOOM llama.cpp 8B Q2 Capability 001")',
    'out_dir = llama_root / "8b-q4" / run_id':
        'out_dir = llama_root / "8b-q2" / run_id',
}
...
def main() -> int:
    ...
    namespace = {
        "__name__": "loom_llama_cpp_8b_q2_impl",
        "__file__": str(here),
        "__package__": None,
    }
