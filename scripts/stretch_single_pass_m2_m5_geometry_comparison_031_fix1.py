#!/usr/bin/env python3
"""LOOM Stretch 031 — balanced M2 vs M5 geometry comparison, harness Fix1.

Fix1 never reuses the failed original constituent.  It first renders both final
runtime sources and validates the single-factor invariant without starting MLX.
"""
...
from stretch_single_pass_geometry_harness_031_fix1 import default_preflight_dir, preflight

SOURCE_M5_PATH = Path("scripts/stretch_single_pass_m5_ten_token_control_031_fix1.py")
SOURCE_M5_BLOB = "e1bd91bc591633c416f10f84ec7d49224fe0249e"
SOURCE_M2_PATH = Path("scripts/stretch_single_pass_m2_ten_token_variant_031_fix1.py")
SOURCE_M2_BLOB = "4e0c969abcea77395808970b2b2808e9ed5ce83d"
...
def main() -> int:
    ...
    if args:
        ...
        try:
            ...
            print(f"Classification: STRETCH_031_FIX1_PREFLIGHT_FAIL", file=sys.stderr)
    ...
    try:
        ...
        print("Classification: STRETCH_031_FIX1_PREFLIGHT_FAIL", file=sys.stderr)
        print(f"Failure reason: {type(exc).__name__}: {exc}", file=sys.stderr)
        return 2
    ...
    run_dir = repo / "results-local" / "stretch" / "single-pass-m2-m5-geometry-comparison-031-fix1" / run_id
    run_dir.mkdir(parents=True, exist_ok=False)
    summary_path = run_dir / "summary.json"
    summary: dict = {
        "experiment": "Stretch 031 — Balanced M2 vs M5 SINGLE_PASS Geometry Comparison Fix1", 
        "harness_revision": "Fix1: final-source summary-title anchor + generated-source preflight", 
